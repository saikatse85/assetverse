  ...
  return (
    <section className="bg-base-100 dark:bg-gray-900 py-20 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 text-center mb-12">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-700 dark:text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        {benefits.map((benefit, index) => (
          <div
            key={index}
            className="bg-base-50 hover:bg-primary text-gray-700 dark:text-white p-6 border border-l-white rounded-xl shadow hover:shadow-lg transition"
          >
